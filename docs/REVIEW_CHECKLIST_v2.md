...
- [x] 純粋制御とDOM統合を分離する。
- [x] P2-04対象18件が再現したNode環境で合格した。
- [ ] 既存テストを含むリポジトリ全体の`npm test`は未確認。
- [ ] 実ブラウザでundo、リタイア、詰みを確認していない。
- [ ] 320×568で主要操作と確認パネルを確認していない。
- [ ] iPhone、iPad実機は未確認。
...
- [x] P2-05対象18件が再現したNode環境で合格した。
- [ ] 既存テストを含むリポジトリ全体の`npm test`は未確認。
- [ ] `git diff --check`は未確認。
- [ ] 実ブラウザで結果、再挑戦、共有を確認していない。
- [ ] 320×568、390×844、PCを確認していない。
- [ ] iPhone、iPad実機は未確認。
